...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_of_attention_heads, embedding_dim, context_length, dropout):
        ...
        self.heads = nn.ModuleList([Head(embedding_dim, head_size, context_length, dropout) for _ in range(num_of_attention_heads)])
...
class Block(nn.Module):
    ...
    def __init__(self, embedding_dim, num_of_attention_heads, context_length, dropout):
        ...
        if num_of_attention_heads == 1:
            ...
            self.sa = MultiHeadAttention(num_of_attention_heads, embedding_dim, context_length, dropout)
...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_dim, num_of_attention_heads, num_of_blocks, context_length, dropout=0.2, device="cpu"):
        super().__init__()
        ...
        self.blocks = nn.Sequential(*[Block(embedding_dim, num_of_attention_heads, context_length, dropout) for _ in range(num_of_blocks)])
